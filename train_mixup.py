...
parser.add_argument('--model', default='pointnet_cls_mixup', help='Model name: pointnet_cls or pointnet_cls_basic [default: pointnet_cls]')
...
def train():
    with tf.Graph().as_default():
        with tf.device('/gpu:'+str(GPU_INDEX)):
            ...
            loss_a = MODEL.get_loss(pred, labels_a_pl, end_points)
            loss_b = MODEL.get_loss(pred, labels_b_pl, end_points)
            loss = tf.multiply(loss_a, lam_pl) + tf.multiply(loss_b, (1-lam_pl))
    ...
    for fn in range(len(TEST_FILES)):
        ...
        for batch_idx in range(num_batches):
            ...
            feed_dict = {ops['pointclouds_pl']: current_data[start_idx:end_idx, :, :],
                         ops['labels_a_pl']: current_label[start_idx:end_idx],
                         ops['labels_b_pl']: current_label[start_idx:end_idx],
                         ops['is_training_pl']: is_training,
                         ops['lam_pl']: 1}
